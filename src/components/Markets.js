        ...
        <div className='component exchange__markets'>
            ...
            { 
                ...
                <select name = "markets" id = "markets" onChange = { switchMarkets }>
                    <option value = { `${config[chainID].UZR.address },${ config[chainID].mETH.address }`}> UZR / mETH </option>
                    <option value = { `${config[chainID].UZR.address },${ config[chainID].mDAI.address }`}> UZR / mDAI </option>
                </select>
                :
                <em>
                    <small> UZR crypto currency not deployed to this netowrk. No markets to show. Try changing the network from above. </small>
                </em>
            }
            <hr />
        </div>
